...
const CollegeSummaryCardMobile: React.FC<CollegeSummaryCardProps> = ({
    ...
    return (
      <div className="flex-col items-center justify-between h-fit pt-5 pb-16 p-8 mb-4 bg-white dark:bg-black rounded-xl">
        <div className="flex justify-between items-center mb-4">
          <Image
        ...
        <div>
          <p className="text-gray-700 dark:text-gray-500 mb-4">{stats?.games} games played</p>
        </div>
